...
export default function Footer() {
    return (
        <footer style={{fontWeight: 'bold'}} class="text-white font-weight-normal">
  <div class="container p-4">
    <div class="row">
      <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
        <h5 class=""><img style={{width:'45px',marginLeft:'-10px',marginTop: '-5px'}} src={logo} /> Recetti</h5>
  ...
  <div class="text-center p-3" > 
    <a style={{color: '#fff'}} class="text-white font-weight-bold" href="https://recetti.tn"> Recetti - Votre meilleur espace de découvrir et partager des recettes.</a>
  </div>
</footer>
    )
}